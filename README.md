...
## Requirements
NVIDIA Docker, follow the instructions here: https://github.com/NVIDIA/nvidia-docker/wiki/Installation

Code to deploy Samim23's char-rnn-api: https://github.com/samim23/char-rnn-api in an nvidia-docker.

To build: `nvidia-docker build -t char-rnn-api .`

To run: `nvidia-docker run --name char-rnn-api -p 8080:8080 -d char-rnn-api`

Or run the docker from dockerhub: `nvidia-docker run -p 8080:8080 -d maxlfarrell/char-rnn-api`

To get into the docker to train a new model run: `nvidia-docker exec -it char-rnn-api bash`, to train the model follow the instructions below

The following is from the char-rnn github https://github.com/karpathy/char-rnn :
